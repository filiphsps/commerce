...
collapses them into one primitive set; the CMS Editor Unification work
migrates the remaining collections and the bridge entities.
...
- [Collections reference](/docs/cms/collections/) — the Payload collection configs

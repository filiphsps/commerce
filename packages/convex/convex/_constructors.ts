 ...
 * re-exports exactly four builders — the two tenant-scoped constructors ({@link tenantQuery},
 * {@link tenantMutation}) and the two server-trusted system-tier constructors ({@link systemQuery},
 * {@link systemMutation}) — and NOTHING from `_generated/server`.
 *

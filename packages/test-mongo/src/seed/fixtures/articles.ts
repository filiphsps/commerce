/**
 * Article fixtures for the seeded demo tenant. Ten published articles
 * spanning a full year of publish dates, varied authors, varied tag sets,
 * and full Lexical-formatted bodies of differing length so feed renderers
 * (chronological order, tag filters, "more articles" rails) and individual
 * article templates both have content.
 */

/**
 * Business-data fixture for the seeded demo tenant. Carries a complete
 * mailing address and a handful of public profiles so storefront SEO /
 * structured-data renderers have real strings to interpolate.
 */
export const businessDataFixture = {

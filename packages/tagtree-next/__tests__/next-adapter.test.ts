import { type AdapterCtx, consoleLogger, defineCache } from '@tagtree/core';
...
describe('nextAdapter', () => {
    it('wrap delegates to unstable_cache with key + tags + revalidate', async () => {
        ...
        expect(unstableCacheMock).toHaveBeenCalledWith(fetcher, ['the-key'], { tags: ['t1', 't2'], revalidate: 60 });

...
/**
 * Renders the collectionMetadata collection fields via Payload's `<RenderFields>`.
 *
 ...
 *
 * The collectionMetadata collection has:
...
export function CollectionMetadataFields() {
    ...
    const collectionConfig = getEntityConfig({ collectionSlug: 'collectionMetadata' });
    ...
    return (
        <RenderFields
            ...
            parentIndexPath=""
            parentPath=""
            parentSchemaPath="collectionMetadata"
            permissions={true}
        />
    );
}

...
export default async function CollectionMetadataVersionsPage({ params }: { params: Params }) {
        ...
        return (
            <div className="mx-auto max-w-3xl px-6 py-10">
                <header className="mb-8 flex items-center justify-between">
                    <h1 className="font-semibold text-2xl">Collection Metadata — Versions</h1>
                    <nav>
                        <Link
                            href={`/${domain}/content/collection-metadata/${encodeURIComponent(handle)}/` as Route}
    ...
    const restoreMetadataVersion = (versionId: string) =>
        restoreVersionAction.bind(null, domain, 'collectionMetadata', versionId);

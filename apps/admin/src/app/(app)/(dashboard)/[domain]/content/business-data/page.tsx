...
export default async function BusinessDataPage({ params, searchParams }: BusinessDataPageProps) {
    ...
    const boundSaveDraft = saveBusinessDataDraftAction.bind(null, domain);
    const boundPublish = publishBusinessDataAction.bind(null, domain);
        ...
        <DocumentForm
            ...
            toolbar={
                <>
                    ...
                    <BusinessDataForm saveDraftAction={boundSaveDraft} publishAction={boundPublish} />
                </>
            }

...
export type EditCollectionMetadataProps = {
    params: Promise<{ domain: string; handle: string }>;
    searchParams: Promise<{ locale?: string }>;
};

export default async function EditCollectionMetadataPage({ params, searchParams }: EditCollectionMetadataProps) {
    ...
    const { state: initialState } = await buildFormState({
        collectionSlug: 'collectionMetadata',
        data: existing ?? {},
    ...
    const boundSaveDraft = saveCollectionMetadataDraftAction.bind(null, domain, handle);
    const boundPublish = publishCollectionMetadataAction.bind(null, domain, handle);
        ...
        <DocumentForm
            ...
            toolbar={
                <>
                    ...
                    <CollectionMetadataForm saveDraftAction={boundSaveDraft} publishAction={boundPublish} />
                </>
            }
        >

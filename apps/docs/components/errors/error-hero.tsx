...
export function ErrorHero({ code, description, errorClass, kind, classHref }: ErrorHeroProps) {
    return (
        <div className="not-prose relative mb-8 grid grid-cols-[1fr_auto] items-end gap-8 overflow-hidden rounded-[0.45rem] border-[0.2rem] border-err bg-[linear-gradient(135deg,hsl(28_95%_58%_/_0.13),hsl(28_95%_58%_/_0.02)_60%,transparent)] px-7 py-7 shadow-[0_0_50px_hsl(28_95%_58%_/_0.12),inset_0_0_0_1px_hsl(28_95%_58%_/_0.1)]">
            <div
                aria-hidden
            ...
            <div className="relative z-[1]">
                <h1 className="m-0 break-all font-mono font-bold text-[2.1rem] text-err leading-none tracking-[0.005em]">
                    {code}
                </h1>
                <p className="mt-3.5 max-w-[50ch] font-semibold text-[1.05rem] text-fg leading-snug">{description}</p>
            </div>

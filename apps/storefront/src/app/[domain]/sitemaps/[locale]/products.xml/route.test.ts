...
function makeRequest(): Request {
    return new Request('http://staging.storefront.localhost/staging.storefront.localhost/sitemaps/en-US/products.xml');
}
...
describe('app/[domain]/sitemaps/[locale]/products.xml', () => {
    describe('GET', () => {
        ...
        it('includes locale code and shop domain in product URLs', async () => {
            ...
            const body = await res.text();
            expect(body).toContain('https://staging.storefront.localhost/en-US/products/demo-product/');
        });

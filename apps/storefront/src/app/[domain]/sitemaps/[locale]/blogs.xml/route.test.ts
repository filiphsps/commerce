...
function makeRequest(): Request {
    return new Request('http://staging.storefront.localhost/staging.storefront.localhost/sitemaps/en-US/blogs.xml');
}
...
describe('app/[domain]/sitemaps/[locale]/blogs.xml', () => {
    describe('GET', () => {
        ...
        it('includes blog and article handles in the sitemap body', async () => {
            ...
            // blog index URL
            expect(body).toContain('https://staging.storefront.localhost/en-US/blogs/news/');
            // article URLs

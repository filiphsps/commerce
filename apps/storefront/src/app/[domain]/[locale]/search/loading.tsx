    ...
    return (
        <PageContent>
            <div className="flex h-16 overflow-clip rounded-lg bg-(--surface-0)">
                ...
                />
                <div
                    className="w-32 rounded-r-lg border-(--border-strong) border-2 border-l-0 border-solid"
                    data-skeleton
                />
            </div>
            <div className="mt-6 grid grid-cols-2 gap-(--block-spacer-huge) md:grid-cols-3 lg:grid-cols-4">

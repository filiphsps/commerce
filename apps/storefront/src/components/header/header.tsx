...
const HeaderComponent = async ({ domain, locale, i18n, ...props }: HeaderProps) => {
    ...
    return (
        <section
            className="sticky top-0 z-10 flex w-full flex-col items-center overscroll-contain shadow-none transition-shadow duration-150 group-data-[menu-open=true]/body:shadow-lg group-data-[scrolled=true]/body:shadow-lg md:max-h-[95dvh]"
            {...props}
        >

                        ...
                        {images.map((thumbnail, index) => {
                            ...
                            return (
                                <button
                                    ...
                                    onClick={() => {
                                        if (!isActive) setImage(thumbnail);
                                    }}
                                    className={cn(
                                        'focus-ring hover:border-(color:var(--accent)) flex size-16 shrink-0 appearance-none items-center justify-center rounded-lg border-2 border-solid bg-(--surface-2) p-1 motion-safe:transition-colors md:aspect-4/5 md:size-auto md:w-full md:p-2',

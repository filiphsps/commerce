...
export const CARD_STYLES =
    'group/card relative flex min-h-[20rem] flex-col overflow-hidden rounded-xl border-2 border-solid border-gray-200 bg-gray-100 p-1 transition-shadow hover:shadow-xl w-full focus-within:border-gray-400';

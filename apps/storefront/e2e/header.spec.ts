...
test.describe('Header (CMS)', () => {
    ...
    test.skip('closes the mega-menu on outside click', async ({ page }) => {
        await page.goto('/');
        await page.getByRole('button', { name: /Menu: Editorial/i }).click();
        await expect(page.getByText('Pucker-up classics.')).toBeVisible();
